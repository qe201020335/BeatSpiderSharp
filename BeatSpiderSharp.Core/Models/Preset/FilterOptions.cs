...
public class FilterOptions
{
    ...
    public LogicOption<string> ExcludeTags { get; set; } = new();
    ...
    public LogicOption<MCharacteristics> IncludeCharacteristics { get; set; } = new();
    public LogicOption<MDifficulty> IncludeDifficulties { get; set; } = new();
    public LogicOption<MMod> RequireMods { get; set; } = new();
    public LogicOption<MMod> ExcludeMods { get; set; } = new();
    ...
    public Option<RankingStatus> ScoreSaberRanking { get; set; } = new(RankingStatus.Unranked);
    public Option<RankingStatus> BeatLeaderRanking { get; set; } = new(RankingStatus.Unranked);
